...
nadpis = wrap.sprite.add_text(' МИССИЯ ', 500, 400, font_size=50, italic=True, text_color=(255, 250, 0),
...
def poxod_na_missiyo(pos_x, pos_y):
    global posledniy_pos_x, posledniy_pos_y, mode
...
def mesto_spr_na_krane(sprite_m, sprite_b):
    """
    Ровно ставит спрайты на экране
    :param sprite_m:
    :param sprite_b:
    """
